...
**2)** SpaceX historically resisted going public but is now pursuing an IPO to fund space-based data centers. What is the most accurate explanation? (3 marks)

A. Public markets always value companies higher than private markets
B. Management prefers regulatory scrutiny
C. The company needs large, immediate capital for a high-risk, capital-intensive project
D. Employees are demanding liquidity above all else
